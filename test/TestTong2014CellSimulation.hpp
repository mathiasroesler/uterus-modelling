#ifndef TESTTONG2014CELLSIMULATION_HPP_
#define TESTTONG2014CELLSIMULATION_HPP_
...
public:
    ...
    {
#ifdef CHASTE_CVODE
        boost::shared_ptr<SimpleStimulus> p_stimulus(new SimpleStimulus(-0.25, 2000.0, 1000.0));
        boost::shared_ptr<AbstractIvpOdeSolver> p_solver;
        boost::shared_ptr<AbstractCvodeCell> p_model(new CellTong2014FromCellMLCvode(p_solver, p_stimulus));
        ...
        solution.WriteToFile("TestSingleCellSimulation", "Tong2014Cvode", "ms", steps_per_row, clean_dir, precision, include_derived_quantities);
...
#endif /*TESTTONG2014CELLSIMULATION_HPP_*/
